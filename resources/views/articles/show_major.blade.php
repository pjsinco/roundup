                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ $article['link'] }}" target="_blank">
                                                <img alt="Image" border="0" alt="{{ $article['img_alt'] }}" class="fullwidth" src="{{ $article['img_src'] }}" style="display: block;" width="320">
                                            </a>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <table class="fullwidth" style="border-collapse: collapse;" width="400" cellspacing="0" cellpadding="0" align="center">
                                                <tbody>
                                                    <tr>
                                                        <td style="font-family: helvetica; font-size: 12px; color: #ef3f23; line-height: 18px; padding-bottom: 10px; font-weight: 200; text-transform: uppercase; letter-spacing: 1px;" align="center">{{ $article['kicker'] }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="font-family: helvetica; font-size: 14pt; color: #2a2a2a; line-height: 18px; padding-bottom: 10px;" align="center">
                                                            <a href="{{ $article['link'] }}" style="color: #2a2a2a; text-decoration: none; font-family: helvetica; font-size: 20px; line-height: 26px; font-weight: normal;" target="_blank">{{ $article['title'] }}</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="font-family: helvetica; font-size: 14px; color: #686d75; line-height: 20px; font-weight: normal;" align="center">{{ $article['excerpt'] }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                    </tr>
